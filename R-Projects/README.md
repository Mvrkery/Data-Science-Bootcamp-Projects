...
[Click here]([url](https://github.com/Mvrkery/Data-Science-Bootcamp-Projects/blob/main/R-Projects/Diamonds-Visualization-Report.md)) to view the R Markdown file for the diamonds data visualization.
